...
abstract class BaseProductCategoryI18nPeer {
	...
	const TABLE_NAME = 'product_category_i18n';
	...
	const NAME = 'product_category_i18n.NAME';

	
	const DESCRIPTION = 'product_category_i18n.DESCRIPTION';

	
	const ID = 'product_category_i18n.ID';

	
	const CULTURE = 'product_category_i18n.CULTURE';
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (ProductCategoryI18nPeer::NAME, ProductCategoryI18nPeer::DESCRIPTION, ProductCategoryI18nPeer::ID, ProductCategoryI18nPeer::CULTURE, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (ProductCategoryI18nPeer::NAME => 0, ProductCategoryI18nPeer::DESCRIPTION => 1, ProductCategoryI18nPeer::ID => 2, ProductCategoryI18nPeer::CULTURE => 3, ),
	...
	{
		include_once 'lib/model/map/ProductCategoryI18nMapBuilder.php';
		return BasePeer::getMapBuilder('lib.model.map.ProductCategoryI18nMapBuilder');
	}
	
	public static function getPhpNameMap()
	{
		if (self::$phpNameMap === null) {
			$map = ProductCategoryI18nPeer::getTableMap();
	...
	const COUNT = 'COUNT(product_category_i18n.ID)';
	const COUNT_DISTINCT = 'COUNT(DISTINCT product_category_i18n.ID)';
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		if ($distinct || in_array(Criteria::DISTINCT, $criteria->getSelectModifiers())) {
			$criteria->addSelectColumn(ProductCategoryI18nPeer::COUNT_DISTINCT);
		} else {
			$criteria->addSelectColumn(ProductCategoryI18nPeer::COUNT);
		}
		...
		$rs = ProductCategoryI18nPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	{
		return ProductCategoryI18nPeer::populateObjects(ProductCategoryI18nPeer::doSelectRS($criteria, $con));
	}
	
	public static function doSelectRS(Criteria $criteria, $con = null)
	{

    foreach (sfMixer::getCallables('BaseProductCategoryI18nPeer:addDoSelectRS:addDoSelectRS') as $callable)
    {
	...
	public static function doCountJoinProductCategory(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ProductCategoryI18nPeer::ID, ProductCategoryPeer::ID);
	...
	public static function doSelectJoinProductCategory(Criteria $c, $con = null)
	{
		...
		$startcol = (ProductCategoryI18nPeer::NUM_COLUMNS - ProductCategoryI18nPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getProductCategory(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addProductCategoryI18n($obj1); 					break;
				}
			}
			if ($newObject) {
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			$criteria = clone $values; 		} elseif ($values instanceof ProductCategoryI18n) {
			...
			$criteria->add(ProductCategoryI18nPeer::ID, $vals[0], Criteria::IN);
			$criteria->add(ProductCategoryI18nPeer::CULTURE, $vals[1], Criteria::IN);
		}
...
if (Propel::isInit()) {
			try {
		BaseProductCategoryI18nPeer::getMapBuilder();
	} catch (Exception $e) {
		Propel::log('Could not initialize Peer: ' . $e->getMessage(), Propel::LOG_ERR);
	}
} else {
			require_once 'lib/model/map/ProductCategoryI18nMapBuilder.php';
	Propel::registerMapBuilder('lib.model.map.ProductCategoryI18nMapBuilder');
}
